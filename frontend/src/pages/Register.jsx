    ...
    return (
        <div className="min-h-screen flex bg-white">
            ...
            <div className="hidden lg:block lg:w-1/2 relative">
                <img
                    src="https://images.unsplash.com/photo-1556228720-1957be83f304?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
                    alt="Nature Background"
                    className="absolute inset-0 w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-nature-primary/40 flex items-center justify-center">
                    <div className="text-white text-center p-8">
                        <h2 className="text-5xl font-display font-bold mb-4">Join the Community</h2>
                        <p className="text-xl font-light">Begin your journey to natural wellness.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            Or{' '}
                            <Link to="/login" className="font-medium text-nature-primary hover:text-nature-accent transition-colors">
