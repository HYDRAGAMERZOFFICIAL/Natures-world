                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            {user ? (
                                <button
                                    onClick={logout}
                                    className="hidden md:block text-sm text-nature-secondary hover:text-nature-accent transition-colors duration-300"
                                >
                                    Logout
                                </button>
                            ) : (
                                <Link to="/login" className="hidden md:block text-sm text-nature-secondary hover:text-nature-accent transition-colors duration-300">
                                    Sign In
                                </Link>
                            )}
                            ...
                            <div className="md:hidden flex items-center">
                                <button
                                    ...
                                    className="text-nature-secondary hover:text-nature-accent focus:outline-none"
                                >
